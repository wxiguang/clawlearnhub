      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-10">
          ...
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
              <li><a href="#getting-started" className="hover:text-white transition-colors">{isZh ? '5 小时快速自学课程' : '5 Hours Rapid Self-Study Course'}</a></li>
              <li><a href={`${prefix}/resources`} className="hover:text-white transition-colors">{isZh ? '全部资源' : 'All Resources'}</a></li>
              <li><a href="https://claw-wiki.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{isZh ? '龙虾百科全书' : 'OpenClaw Wiki'}</a></li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
              ...
              <li><a href="https://www.youtube.com/results?search_query=openclaw" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">▶️ {isZh ? 'Youtube学习资源' : 'Youtube Resources'}</a></li>
              ...
              <li><a href="https://www.skill-cn.com?from=clawlearnhub.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{isZh ? 'Skill Hub 中国' : 'Skill Hub CN'}</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-xs sm:text-sm mb-2 sm:mb-3" style={{ color: 'rgba(255,255,255,0.8)' }}>
        ...
        <div className="border-t border-white/10 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            <div className="text-xs sm:text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
              Made by <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" style={{ color: 'rgba(255,255,255,0.8)' }}>{isZh ? 'Terry' : 'Terry'}</a> | OpenClaw Learn hub
            </div>
