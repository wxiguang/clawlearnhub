...
const featuresZh = [
  ...
  },
  {
    icon: '⚡',
    title: '技能扩展',
    desc: '5494+ 社区技能，从天气查询到代码生成，一键安装即用。',
  },
  {
    icon: '🔒',
    title: '数据自主',
...
const featuresEn = [
  ...
  },
  {
    ...
    desc: '5494+ community skills, from weather queries to code generation. One-click install.',
  },
  {
    icon: '🔒',
    title: 'Self-Hosted',
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="reveal text-center">
          ...
          >
            ...
            <span className="font-semibold">279k+ Stars</span>
