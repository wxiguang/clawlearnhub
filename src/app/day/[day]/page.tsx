...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Day ${dayNum}: ${titles[dayNum]?.en || ''} | OpenClaw Learn Hub`;
  
  return {
    title,
    description: data.frontmatter.description,
    alternates: {
      canonical: `https://clawlearnhub.com/day/${day}`,
      languages: {
        'en': `https://clawlearnhub.com/day/${day}`,
        'zh': `https://clawlearnhub.com/zh/day/${day}`,
      },
    },
    openGraph: {
      title,
      description: data.frontmatter.description,
      type: 'article',
      url: `https://clawlearnhub.com/day/${day}`,
    },
  };
}
